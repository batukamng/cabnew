            ...
            $ocLazyLoadProvider.config({
                ...
                modules: [
                    ...
                    // ----------- SWEET COMPONENTS -----------
                    {
                        name: 'lazy_arcgis',
                        files: [
                            // 'kendoui/arcgis/arcgis.js',
                            // 'kendoui/arcgis/main.css'
                        ],
                        serie: true
                    },
                    ...
                    // ----------- KENDOUI COMPONENTS -----------
                    {
                        ...
                        files: [
                            ...
                            /* 'kendoui/styles/default-main.css',*/
                            'kendoui/styles/bootstrap-4.css'
                        ],
                        serie: true
                    },
                    {
                    ...
                    // ----------- SWEET COMPONENTS -----------
                    {
                        name: 'lazy_chart',
                        files: [
                            'kendoui/amcharts/core.js',
                            'kendoui/amcharts/charts.js',
                            'kendoui/amcharts/forceDirected.js',
                            'kendoui/amcharts/themes/animated.js',
                            'app/chart.js'
                        ],
                        serie: true
                    },
                    ...
                    // ----------- SWEET COMPONENTS -----------
                    {
                        name: 'lazy_sweet',
                        files: [
                            'kendoui/ngSweetAlert-master/sweetalert.css',
                            'kendoui/ngSweetAlert-master/google.css',
                            'kendoui/ngSweetAlert-master/sweetalert.min.js',
                            'kendoui/ngSweetAlert-master/ngSweetAlert.js'
                        ],
                        serie: true
                    },
                    {
                        name: 'lazy_leaf',
                        files: [
                            'assets/js/leaflet/leaflet-search/dist/leaflet-search.min.css',
                            'assets/js/leaflet/leaflet.draw-src.css',
                            'assets/js/leaflet/leaflet.css',
                            'assets/js/leaflet/angular-simple-logger.js',
                            'assets/js/leaflet/ui-leaflet.min.js',
                            // 'assets/icons/map-icons/icomoon/style.css',
                            'assets/js/leaflet/leaflet.js',
                            'assets/js/leaflet/ui-leaflet.min.js',
                            'assets/js/leaflet/Control.Loading.js',
                            'assets/js/leaflet/leaflet-search/dist/leaflet-search.src.js',
                            'assets/js/leaflet/leaflet-draw/dist/leaflet.draw-src.js',
                            'assets/js/leaflet/leaflet-easyprint/dist/bundle.js',
