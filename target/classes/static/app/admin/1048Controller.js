        ...
        [
            ...
            function ($rootScope, $state, $scope, $timeout, __env, fileUpload,$translate) {
                ...
                $scope.parentEditor = function (container, options) {
                    ...
                    var editor = $('<input kendo-drop-down-list  k-data-text-field="\'text\'" k-data-value-field="\'value\'" k-data-source="ddlDataSource" data-bind="value:' + options.field + '"/>')
                        .appendTo(container);
                };
                ...
                $scope.mainGrid = {
                    ...
                    columns: [
                       ...
                       /* {field: "parentId", template:"#if(auditOrganization!=null){#<span>#=auditOrganization.name#</span> #}else{# <span>ROOT</span> #}#", editor:$scope.parentEditor,headerAttributes: {"class": "columnHeader"},title: '{{"Org" | translate}}'},*/
                        {field: "nameMon", headerAttributes: {"class": "columnHeader"},title:'Байгууллагын нэр'},
                        {field: "lpReg",headerAttributes: {"class": "columnHeader"},title: 'Регистр'},
                ...
                if(JSON.parse(localStorage.getItem('privilege'))!=null){
                    ...
                    angular.forEach(privileges, function(value, key) {
                        ...
                        if(value.name==='WRITE'){
                            $scope.mainGrid.toolbar = ["create",{template: "<button class='k-button k-button-icontext md-btn-primary' ng-click='modalUpload()'><span class=\"k-icon k-i-upload\"></span>Импорт</button>"},"search"];
                        }
