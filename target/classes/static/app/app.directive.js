...
altairApp
            ...
            return {
                ...
                link: function () {
                    $transitions.onSuccess({}, function ($transition) {
                        var default_title = "ЗГХЭГ",
                            state = $transition.to();
                        $timeout(function () {
                            $rootScope.page_title = state.data && state.data.pageTitle ? default_title + " - " + state.data.pageTitle : default_title;
                        });
                    });
                },
            };
    ...
    .directive('angularTreeTable', function () {
        return {
            restrict: 'EA',
            transclude: true,
            scope: {tableData: '=', tableConfig: '='},
            bindToController: true,
            templateUrl: 'app/shared/directives/angularTreeTable.directive.html',
    ...
    .directive("printMessage", function () {
        return {
            ...
            template:
                ...
                '<span ng-show="message.to"> -> {{message.to}}</span>:</strong><div style="color: #626262;" class="msg break-words relative shadow-md rounded py-3 px-4 mb-2 rounded-lg max-w-sm border border-solid border-grey-light bg-white"><span>{{message.message}}</span></div> <br/>',
        };
    })
    .directive("ngFiles", [
        "$parse",
            ...
            return {
                ...
                link: function (scope, el, attr) {
                    ...
                    scope.onClick = function ($event) {
                        ...
                        if ($rootScope.miniSidebarActive && !$($event.target).closest("#sidebar_main").length && !$($event.target).closest("#sSwitch_primary").length && !$rootScope.largeScreen) hideMiniSidebar();
                        // main search form
                    ...
                    scope.onKeyUp = function ($event) {
                        ...
                        if ($rootScope.miniSidebarActive && !$rootScope.largeScreen && $event.keyCode == 27) hideMiniSidebar();
                    };
                },
            };
        },
        ...
        function ($rootScope, $window, $timeout, variables) {
            return {
                ...
                link: function (scope, el, attr) {
                    ...
                    if (attr.toggleHidden == "large") {
                        $rootScope.miniSidebarHiddenLarge = true;
                    }
                    scope.submenuToggle = function ($event) {
                        ...
                        $this.next("ul").velocity("transition.slideLeftIn", {
                            duration: 400,
                            easing: variables.easing_swiftIn,
                            begin: function () {
    ...
    .directive("sidebarPrimaryToggle", [
        ...
        function ($rootScope, $window, $timeout) {
            return {
                ...
                scope: true,
                template:
                    '<a id="sSwitch_primary" href="#" class="sSwitch sSwitch_left" ng-click="togglePrimarySidebar($event)" ng-hide="largeScreen || slimSidebarActive || topMenuActive"><span class="sSwitchIcon"></span></a>',
                link: function (scope, el, attrs) {
                    scope.togglePrimarySidebar = function ($event) {
                        $event.preventDefault();
                        console.log(1111, $rootScope.primarySidebarActive);
                        if ($rootScope.primarySidebarActive) {
                            ...
                            // $rootScope.miniSideBarHiding = true;
                            if ($rootScope.largeScreen) {
                                $timeout(function () {
                                    // $rootScope.miniSideBarHiding = false;
                                    $(window).resize();
                                }, 290);
                            }
                        }
                        ...
                        $rootScope.miniSidebarActive = !$rootScope.miniSidebarActive;

                        if (!$rootScope.largeScreen) {
                            // $rootScope.hide_content_sidebar = $rootScope.primarySidebarActive ? true : false;
                            $rootScope.hide_content_sidebar = $rootScope.miniSidebarActive ? true : false;
                        }
            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    ...
                    scope.showNotify = function () {
                        ...
                        if ((w.width() < 768 && (scope.position == "bottom-right" || scope.position == "bottom-left" || scope.position == "bottom-center")) || scope.position == "bottom-right") {
    ...
    .directive("fileUploadOfpp", function () {
        return {
            templateUrl: "app/shared/directives/fileuploadOfppView.html",
            link: function (scope, element) {
                ...
                var progressbar = $("#file_upload-progressbar"),
                    ...
                    settings = {
                        action: "/api/CaseRelOfpp/upfile", // upload url
                    ...
                    am4core.ready(function () {
                        ...
                        function am4themes_myTheme(target) {
                            if (target instanceof am4core.ColorSet) {
                                target.list = [am4core.color("#ff7336"), am4core.color("#2acb7f"), am4core.color("#62e10e"), am4core.color("#ffc000")];
                                if (attrs.colors) {
                                    var colors = JSON.parse(attrs.colors);
                                    target.list = [];
                                    for (var i = 0; i < colors.length; i++) {
                                        target.list.push(am4core.color(colors[i]));
                                    }
                                }
                            }
                        }
                        ...
                        var chart = am4core.create(attrs.id, am4charts.PieChart);
                        //                        chart.data = JSON.parse(attrs.data);
            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    am4core.ready(function () {
                        ...
                        function am4themes_myTheme(target) {
                            if (target instanceof am4core.ColorSet) {
                                target.list = [am4core.color("#83d1c4"), am4core.color("#78517d"), am4core.color("#f07951")];
                            }
                        }
            ...
            return {
                ...
                link: function (scope, elem, attrs) {
                    am4core.ready(function () {
                        function am4themes_myTheme(target) {
                            if (target instanceof am4core.ColorSet) {
                                target.list = [am4core.color("#ff7336"), am4core.color("#2acb7f")];
                            }
                        }

                        am4core.useTheme(am4themes_myTheme);

                        var chart = am4core.create(attrs.id, am4charts.XYChart);
                        attrs.$observe("data", function (value) {
                            try {
                                chart.data = JSON.parse(value);
                            } catch (e) {
