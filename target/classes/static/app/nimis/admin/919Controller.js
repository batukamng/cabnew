            ...
            $scope.mainGrid = {
                ...
                columns: [
                    ...
                    },
                    {
                        field: "title",
                        title: "Нэр",
                        template:"#if(image!=null){# <div class='avatar-photo' style='background-image: url(#:image.uri#);'></div> #=title#  #}#",
                        headerAttributes: {class: "columnHeader"},
                        filterable: {cell: {operator: "contains", showOperators: false}},
                    },
                    {
            ...
            if (localStorage.getItem("buttonData").includes("update") || localStorage.getItem("buttonData").includes("edit")) {
                $scope.mainGrid.columns.push({
                    command: [
                        {
                            template:
                                '<div style="margin-left: 10px;" class="flex gap-3"><button class="grid-btn k-grid-edit" ng-click=\'update(dataItem)\'><div class="nimis-icon edit"></div></button>' +
