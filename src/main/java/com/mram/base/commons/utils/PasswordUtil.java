package com.mram.base.commons.utils;

import com.mram.base.exceptions.nullpointer.NullPasswordException;
import org.springframework.security.crypto.bcrypt.BCryptPasswordEncoder;

public final class PasswordUtil {
    public static final int PASS_MIN_SIZE = 6;
    public static final int CRYPTO_STRENGTH = 512;

    public enum EncType {
        SHA_ENCODER, BCRYPT_ENCODER
    }
    ...
    public static String encryptPassword(String password, EncType encryptType, String salt)
