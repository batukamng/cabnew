...
public class ExcelHelper {
    ...
    /*
     * public static List<Organization> excelToOrganization(InputStream is,
     * List<Governor> generalBudgets, List<CentralGovernor> centralBudgets) {
     * String[] HEADERs = { "TEZ_ID", "TEZ_NAME", "TEZ_REG_NO", "TTZ_REG_NO",
     * "TTZ_NAME", "ENT_NAME", "ORG_REG_NO" };
     * String SHEET = "Sheet1";
     * try {
     ...
     * if(budget.getName().toLowerCase().trim().equalsIgnoreCase(strValue.
     * toLowerCase().trim())){
     ...
     * }
     * 
     * public static List<Governor> excelToGovernor(InputStream inputStream,
     * List<Governor> generalBudgets, List<CentralGovernor> centralBudgets) {
     * String[] HEADERs = { "TEZ_ID", "TEZ_NAME", "TEZ_REG_NO", "TTZ_REG_NO",
     * "TTZ_NAME", "ENT_NAME", "ORG_REG_NO" };
     * String SHEET = "Sheet1";
     ...
     *//*
        ...
        *//*
           ...
           * toLowerCase().trim())){
           * tutorial=budget;
           * String regValue = formatter.formatCellValue(currentRow.getCell(cellIdx+1),
           * evaluator);
