    ...
    .controller(
        ...
        [
            ...
            function ($rootScope, $state, $scope, $timeout, mainService, __env) {
                ...
                $scope.contentEditor = function (container, options) {
                ...
                $scope.mainGrid = {
                    dataSource: {
                        transport: {
                            read: {
                                url: function (e) {
                                    if(sessionStorage.getItem("buttonData").includes("read") && JSON.parse(sessionStorage.getItem('menuData')).link===$state.current.name){
                                        return __env.apiUrl() + "/api/cnt/content/metas/list";
                                    }
                                    else{
                            ...
                            create: {
                                url: __env.apiUrl() + "/api/cnt/content/metas/create",
                                contentType: "application/json; charset=UTF-8",
                                type: "POST",
                                beforeSend: function (req) {
                                    req.setRequestHeader('Authorization', 'Bearer ' + JSON.parse(sessionStorage.getItem('currentUser')).token);
                            ...
                            update: {
                                url: __env.apiUrl() + "/api/cnt/content/metas/update",
                                contentType: "application/json; charset=UTF-8",
                                type: "PUT",
                                beforeSend: function (req) {
                                    req.setRequestHeader('Authorization', 'Bearer ' + JSON.parse(sessionStorage.getItem('currentUser')).token);
                            ...
                            destroy: {
                                url: __env.apiUrl() + "/api/cnt/content/metas/delete",
                                contentType: "application/json; charset=UTF-8",
                                type: "DELETE",
                                beforeSend: function (req) {
                                    req.setRequestHeader('Authorization', 'Bearer ' + JSON.parse(sessionStorage.getItem('currentUser')).token);
                        ...
                        schema: {
                            ...
                            model: {
                                ...
                                fields: {
                                    ...
                                    contentId: {type: "number",validation: {required: true}},
                                    cntContent:{defaultValue:{}}
                                }
                            }
                        },
                        pageSize: 20,
                 ...
                 /*   filterable: {
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            title: "Content",
                            template:"#if(contentId!=0 && cntContent!=null){# #=cntContent.title# #}else{# <span>ROOT</span> #}#",
