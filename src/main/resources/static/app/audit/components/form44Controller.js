    ...
    .controller(
        ...
        [
            ...
            function ($rootScope, $state, $scope, $filter, $timeout, mainService, fileUpload, commonDataSource, sweet, __env) {
                ...
                $scope.$on("formChanged44", function (event, args, data) {
                ...
                $scope.initForm=function (appId,formId){
                    $scope.dataSource471= new kendo.data.DataSource({
                        autoSync:true,
                        transport: {
                            read: {
                            ...
                            update: {
                                ...
                                complete: function (e) {
                                    $("#appData471").data("kendoGrid").dataSource.read();
                                }
                            },
                    ...
                    $scope.dataSource472= new kendo.data.DataSource({
                        autoSync:true,
                        transport: {
                            read: {
                            ...
                            update: {
                                ...
                                complete: function (e) {
                                    $("#appData472").data("kendoGrid").dataSource.read();
                                }
                            },
                            parameterMap: function (options) {
                                return JSON.stringify(options);
                    ...
                    $scope.dataSource473= new kendo.data.DataSource({
                        autoSync:true,
                        transport: {
                            read: {
                                url: __env.apiUrl() + "/api/adt/main/adt-risk-detail/list",
                            ...
                            update: {
                                ...
                                complete: function (e) {
                                    $("#appData473").data("kendoGrid").dataSource.read();
                                }
                            },
                            parameterMap: function (options) {
                                return JSON.stringify(options);
                ...
                $scope.activeTab = function (item) {
                    ...
                    if(item.code==='tab1'){
                        $scope.dataSource471.filter({
                            logic: "and",
                            filters: [{ field: "useYn", operator: "eq", value: 1 },
                                {field: "stepId", operator: "eq", value: 1},
                                {field: "planId", operator: "eq", value: $scope.appId}],
                        });
                    }
                    if(item.code==='tab2'){
                        $scope.dataSource472.filter({
                            logic: "and",
                            filters: [{ field: "useYn", operator: "eq", value: 1 },
