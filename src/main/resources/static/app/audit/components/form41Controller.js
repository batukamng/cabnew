    ...
    .controller(
        ...
        [
            ...
            function ($rootScope, $state, $scope, $filter, $timeout, mainService, fileUpload, commonDataSource, sweet, __env) {
                ...
                $scope.dataSource41 = new kendo.data.DataSource({
                    transport: {
                        read: {
                ...
                $scope.mainGrid41.toolbar = [{template: "<button class='md-btn custom-btn' ng-click='addRisk41()'><i class='material-icons text-white mr-1'>add</i>Нэмэх</button>"}, "search"];
                ...
                var modalForm = UIkit.modal("#modal_form_41", {
                    modal: false,
                    keyboard: false,
                    bgclose: false,
                    center: true
                ...
                $scope.dataItem={};
                $scope.addRisk41 = function (){
                    $scope.dataItem={};
                    UIkit.modal("#modal_form_41", {
                        modal: false,
                        keyboard: false,
                        bgclose: false,
                        center: true
                ...
                $scope.formSubmit = function (type) {
                    var validator = $("#validator41").kendoValidator().data("kendoValidator");
                    if (validator.validate()) {
                        var obj={decType:0,impType:1,planId:$rootScope.app.id,accDirId:$scope.dataItem.accId,queId:$scope.dataItem.queId,typeId:$scope.dataItem.typeId,confId:$scope.dataItem.confId}
                        var method = "post";
                        ...
                        mainService.withdata(method, "/api/adt/main/form34/submit", obj).then(function (data) {
                            ...
                            $timeout(() => $rootScope.clearForm("validator"));
                            $("#appData41").data("kendoGrid").dataSource.read();
                        });
                    }
                };
