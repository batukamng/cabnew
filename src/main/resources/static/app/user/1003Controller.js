            ...
            function ($rootScope, $state, $scope, $timeout, mainService, fileUpload, __env) {
                    ...
                    $scope.governorDataSource = new kendo.data.DataSource({
                        transport: {
                            read: {
                                ...
                                contentType: "application/json; charset=UTF-8",
                                data: { "custom": "where useYn=true ", filter: { logic: "and", filters: arr } },
                                type: "POST",
                                beforeSend: function (req) {
                                    req.setRequestHeader('Authorization', 'Bearer ' + JSON.parse(localStorage.getItem('currentUser')).token);
                                }
                        ...
                        dataSource: {
                            transport: {
                                read: {
                                    ...
                                    contentType: "application/json; charset=UTF-8",
                                    type: "POST",
                                    data: { "custom": "where auth in ('Tra03','mfa')", "sort": [{ field: 'id', dir: 'desc' }] },
                                    beforeSend: function (req) {
                                        req.setRequestHeader('Authorization', 'Bearer ' + JSON.parse(localStorage.getItem('currentUser')).token);
                                    }
                                },
                ...
                $scope.mainGrid = {
                    dataSource: {
                        transport: {
                            read: {
                                ...
                                contentType: "application/json; charset=UTF-8",
                                type: "POST",
                                data: { "custom": "where userType=3", "sort": [{ field: 'id', dir: 'desc' }] },
                                beforeSend: function (req) {
                                    req.setRequestHeader('Authorization', 'Bearer ' + JSON.parse(localStorage.getItem('currentUser')).token);
                                }
                            },
                        ...
                        schema: {
                            ...
                            model: {
                                ...
                                fields: {
                                    ...
                                    userType: { type: "number", defaultValue: 3 },
                    ...
                    columns: [
                        ...
                        { field: "tezId", sticky: true, headerAttributes: { "class": "columnHeader" }, width: 200, template: "#if(governor!=null){# <span>#=governor.name#</span> #}#", editor: $scope.governorEditor, title: 'Төсвийн ерөнхийлөн захирагч' },
                        { field: "spoId", stickable: true, headerAttributes: { "class": "columnHeader" }, width: 200, template: "#if(sponsor!=null){# <span>#=sponsor.name#</span> #}#", editor: $scope.sponsorEditor, title: 'Эрх шилжүүлсэн байгууллага' },
