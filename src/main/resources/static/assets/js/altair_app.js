    ...
    .directive('sidebarPrimaryToggle', [
        ...
        function ($rootScope, $window, $timeout) {
            return {
                ...
                replace: true,
                scope: true,
                template: '<a id="sSwitch_primary" href="#" class="sSwitch sSwitch_left" ng-click="togglePrimarySidebar($event)" ng-hide="slimSidebarActive || topMenuActive || "><span class="sSwitchIcon"></span></a>',
                link: function (scope, el, attrs) {
                    scope.togglePrimarySidebar = function ($event) {
                        $event.preventDefault();
                        console.log($rootScope.primarySidebarActive);
                        ...
                        if($rootScope.primarySidebarActive) {
                           ...
                           else if($rootScope.miniSidebarActive) {
                            ...
                            console.log($rootScope.miniSidebarHiddenLarge, 115555)
                            $rootScope.miniSidebarHiddenLarge = true;
                            if($rootScope.largeScreen) {
                                $timeout(function() {
                                    $rootScope.miniSidebarHiddenLarge = false;
