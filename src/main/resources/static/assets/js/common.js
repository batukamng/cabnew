...
(function (global, factory) {
  ...
  function getAll(context, tag) {
    ...
    var ret =
      typeof context.getElementsByTagName !== "undefined" ? context.getElementsByTagName(tag || "*") : typeof context.querySelectorAll !== "undefined" ? context.querySelectorAll(tag || "*") : [];
        ...
        function buildQueue(next) {
          ...
          if (action === "scroll") {
            ...
            var fixPropertyValue = function (property, valueData) {
              ...
              if (
                ((opts.display !== undefined && opts.display !== null && opts.display !== "none") || (opts.visibility !== undefined && opts.visibility !== "hidden")) &&
                  ...
                  if (/[\d\.-]/.test(cStart) && /[\d\.-]/.test(cEnd)) {
                    ...
                    if (uStart === uEnd) {
                      ...
                      pattern +=
                        ...
                        uStart +
                        " + " +
                        (nEnd ? "{" + (aStart.length + (nStart ? 1 : 0)) + (inRGB ? "!" : "") + "}" : "0") +
                        uEnd +
                        ")";
                      if (nStart) {
                        aStart.push(nStart);
  ...
  !(function (t) {
    ...
    if (!(t[i] && t[i].version > n)) {
      (t[i] = function (t, e) {
        ...
        (t[i].version = n),
        (t[i].uniqueId = 0),
        (t[i].defaults = { ellipsis: "… ", callback: function (t) {}, truncate: "word", tolerance: 0, keep: null, watch: "window", height: null }),
        (t[i].prototype = {
          init: function () {
          ...
          truncate: function () {
            ...
            var t = !1;
            return (
              this._fits() || ((t = !0), this._truncateToNode(this.$inner[0])),
              this.$dot[t ? "addClass" : "removeClass"](s.truncated),
          ...
          watch: function () {
            ...
            "window" == this.opts.watch
              ? h.on(r.resize + t.uniqueId, function (i) {
          ...
          _truncateToLetter: function (t) {
            for (
              var e = this, i = this.__getTextContent(t), n = i.split(""), s = "", o = n.length;
              o >= 0 && ((s = n.slice(0, o).join("")), !s.length || (e.__setTextContent(t, e._addEllipsis(s)), !e._fits()));
              o--
            );
          },
          _fits: function () {
          ...
          _getOriginalContent: function () {
            var e = this;
            return (
              this.$dot.find("script, style").addClass(s.keep),
              this.opts.keep && this.$dot.find(this.opts.keep).addClass(s.keep),
              this.$dot
                .find("*")
                .not("." + s.keep)
                .add(this.$dot)
...
function scrollbarWidth() {
  var a = jQuery('<div style="width: 100%; height:200px;">test</div>'),
    b = jQuery('<div style="width:200px;height:150px; position: absolute; top: 0; left: 0; visibility: hidden; overflow:hidden;"></div>').append(a),
    c = a[0],
    a = b[0];
